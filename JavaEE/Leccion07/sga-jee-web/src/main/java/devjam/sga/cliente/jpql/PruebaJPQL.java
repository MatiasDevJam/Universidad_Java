package devjam.sga.cliente.jpql;
...
public class PruebaJPQL {
    ...
    public static void main(String[] args) {
        ...
        while(iter.hasNext()){
         ...
         //5. Obtiene el objeto Persona y el id, se crea un arreglo de tipo Obejct con 2 columnas
        log.debug("\n5. Obtiene el objeto Persona y el id, se crea un arreglo de tipo Obejct con 2 columnas");
        ...
        System.out.println("\n6. Consulta de todas las personas");;
        jpql = "select new devjam.sga.domain.Persona (p.idPersona) from Persona p";
        personas = em.createQuery(jpql).getResultList();
        mostrarPersonas(personas);
        ...
        persona = (Persona) q.getResultList();
        log.debug(persona);
