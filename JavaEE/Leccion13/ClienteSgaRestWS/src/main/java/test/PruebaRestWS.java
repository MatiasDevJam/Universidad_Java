...
public class PruebaRestWS {
    public static void main(String[] args) {
        ...
        Client cliente = ClientBuilder.newClient((Configuration) clientConfig);
        
        WebTarget webTarget = cliente.target("http://localhost:8080/sga-jee-web/service").path("/personas");
